...
APPDIR="$BUILDDIR/DigiByte-Gaming-chrome-extension"
ZIPFILE="DigiByte-Gaming-chrome-extension.zip"
...
echo "${OpenColor}${Green}* Generating DigiByte-Gaming bundle...${CloseColor}"
grunt
checkOK
...
echo "${OpenColor}${Yellow}\nThe Chrome Extension is ready at $BUILDDIR/DigiByte-Gaming-chrome-extension.zip${CloseColor}"
